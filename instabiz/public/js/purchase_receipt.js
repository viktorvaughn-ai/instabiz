// ── IB Purchase Receipt — SQMT rate recalc (mirrors purchase_order.js) ───────
const _ib_pr_recalc = frappe.utils.debounce(function (frm, cdt, cdn) {
...
const _ib_pr_backfill = frappe.utils.debounce(function (frm, cdt, cdn) {
    const row = locals[cdt][cdn];
...
frappe.ui.form.on("Purchase Receipt Item", {
    custom_sqmt_rate: (frm, cdt, cdn) => _ib_pr_recalc(frm, cdt, cdn),
    rate:             (frm, cdt, cdn) => _ib_pr_backfill(frm, cdt, cdn),
});
