	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				desc: "6 tabs — Sales, Inventory, Production, HR, Finance, Me — each showing KPIs + a trend chart + a breakdown. Every tab is open to every role; what you see inside each tab depends on your role, not which tabs you can click.",
				link: "/app/ib-analytics-hub", linkLabel: "Analytics Hub",
				tags: "analytics hub cross module sales inventory production hr finance me content aware scoped role",
				steps: [
					"Go to <b>Workspace → Dashboards → Analytics Hub</b>. Every role sees all 6 tabs — nothing is hidden or blocked.",
					"<b>Privileged roles</b> (System Manager, Sales Manager, Accounts Manager, Factory Management) see the full company-wide numbers on every tab — unchanged from before.",
					"<b>Everyone else</b> sees a scoped view instead: <b>Sales</b> — your own orders/customers only. <b>Inventory</b> — in-stock / out-of-stock status only per item, no real quantities or stock value. <b>Production</b> — your own Sales Orders' current production stage and dispatch status (same data as the Production Tracker page). <b>HR</b> — your own leave balance, this period's attendance, pending leave requests, last payslip — not company headcount or payroll. <b>Finance</b> — your own customers' outstanding AR and collections only, no AP, no other reps' customers. <b>Me</b> — unchanged, already self-scoped.",
				...
				tip: "If a number looks unexpectedly small on Sales/Production/HR/Finance, check whether you're a privileged role or not — a non-privileged user is intentionally only seeing their own work, not a bug.",
			},
		],
	},
	{
